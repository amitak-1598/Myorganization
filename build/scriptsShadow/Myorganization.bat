...
set CLASSPATH=%APP_HOME%\lib\Myorganization-0.1-all.jar

@rem Execute Myorganization
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %MYORGANIZATION_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%MYORGANIZATION_EXIT_CONSOLE%" exit 1
exit /b 1
